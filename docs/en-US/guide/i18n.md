...
```html
<script src="//unpkg.com/hsmos-ui/dist/locale/zh-cn"></script>
<script>
  app.use(ElementPlus, {
...
[Supported Language List](https://github.com/hsmos-ui/hsmos-ui/tree/dev/packages/locale/lang)
...
If you need any other languages, [PR](https://github.com/hsmos-ui/hsmos-ui/pulls)
is always welcomed, you only need to add a language file at
[here](https://github.com/hsmos-ui/hsmos-ui/tree/dev/packages/locale/lang).
