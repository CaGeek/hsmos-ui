...
import { useDeprecated, useLocale } from '@hsmos-ui/hooks'
import { debugWarn } from '@hsmos-ui/utils'
import { INPUT_EVENT, UPDATE_MODEL_EVENT } from '@hsmos-ui/constants'
...
export const useCalendar = (
  ...
  // https://github.com/hsmos-ui/hsmos-ui/issues/3155
  ...
  useDeprecated(
    {
      ...
      scope: 'ElCalendar',
      version: '2.3.0',
      ref: 'https://hsmos-ui.org/en-US/component/calendar.html#slots',
      type: 'Slot',
    },
